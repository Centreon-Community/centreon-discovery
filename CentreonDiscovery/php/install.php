...
*/
	/* Windows */
		if ( queryIsEmpty('SELECT command_id FROM command WHERE command_name = "check_teamreon_interface_ping"') == 0 ) {
			if ( !mysql_query('INSERT INTO command (command_id,command_name,command_line,command_example,command_type,graph_id,cmd_cat_id) VALUES (NULL,"check_teamreon_interface_ping","$USER1$#S#check_teamreon_interface_ping-H$HOSTADDRESS$-n$ARG1$-w$ARG2$-c$ARG3$","!3!200,20%!400,50%",2,NULL,NULL)') ) { echo mysql_error(); }
		}
...
*/
	...
	if ( $num_row_service_id_generic > 0 ) {
		...
		*/
			/*NIC*/
			if ( queryIsEmpty('SELECT service_id FROM service WHERE service_description = "Template_TeamReon_Win2K3_NIC"') == 0 ) {
				...
				if ( !mysql_query('INSERT INTO extended_service_information (esi_id,service_service_id,esi_notes,esi_notes_url,esi_action_url,esi_icon_image,esi_icon_image_alt,graph_id) VALUES (NULL,(SELECT service_id FROM service WHERE service_description = "Template_TeamReon_Win2K3_NIC" LIMIT 1),NULL,NULL,NULL,NULL,NULL,NULL)')  ) { echo mysql_error(); }
			}
...
//			}
		...
		*/
			...
			if ( queryIsEmpty('SELECT service_id FROM service WHERE service_description = "Template_TeamReon_Linux_Memory"') == 0 ) {
				if ( !mysql_query('INSERT INTO service (service_id,service_template_model_stm_id,command_command_id,timeperiod_tp_id,command_command_id2,timeperiod_tp_id2,service_description,service_alias,display_name,service_is_volatile,service_max_check_attempts,service_normal_check_interval,service_retry_check_interval,service_active_checks_enabled,service_passive_checks_enabled,initial_state,service_parallelize_check,service_obsess_over_service,service_check_freshness,service_freshness_threshold,service_event_handler_enabled,service_low_flap_threshold,service_high_flap_threshold,service_flap_detection_enabled,service_process_perf_data,service_retain_status_information,service_retain_nonstatus_information,service_notification_interval,service_notification_options,service_notifications_enabled,service_first_notification_delay,service_stalking_options,service_comment,command_command_id_arg,command_command_id_arg2,service_register,service_activate) VALUES (NULL,'.$service_id_generic.',(SELECT command_id FROM command WHERE command_name = "check_teamreon_memory_linux" LIMIT 1),NULL,NULL,NULL,"Template_TeamReon_Linux_Memory","Taux Utilisation Memoire (Used, RAM, Swap)",NULL,"2",NULL,NULL,NULL,"2","2",NULL,"2","2","2",NULL,"2",NULL,NULL,"2","2","2","2",NULL,NULL,"2",NULL,NULL,NULL,"",NULL,"0","1")')  ) { echo mysql_error(); }
		...
		*/
		...
		/* Windows */
//			if ( !mysql_query('INSERT INTO ServiceOID (ServiceOID_id, OIDGroup_id_id) VALUES ((SELECT service_id FROM service WHERE service_description = "Template_TeamReon_Win2K3_NIC" LIMIT 1),101)')  ) { echo mysql_error(); }
