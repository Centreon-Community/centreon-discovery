...
INSERT INTO `command` (`command_name`, `command_line`, `command_example`, `command_type`, `graph_id`) VALUES ('check_discovery_env', '$USER1$/check_snmp_env.pl -H $HOSTADDRESS$ -C $_HOSTSNMPCOMMUNITY$ -2 -T $ARG1 -f', '!cisco', '2', '');
SELECT @newCmdId := MAX(command_id) FROM command;
DELETE FROM `command_arg_description` WHERE cmd_id = '@newCmdId';
...
INSERT INTO `command` (`command_name`, `command_line`, `command_example`, `command_type`, `graph_id`) VALUES ('check_discovery_disk', '$USER1$/check_centreon_snmp_remote_storage -H $HOSTADDRESS$ -C $_HOSTSNMPCOMMUNITY$ -v 2 -d "$ARG1$" -n -w $ARG2$ -c $ARG3$', '!C:!80!90', '2', '');
SELECT @newCmdId := MAX(command_id) FROM command;
DELETE FROM `command_arg_description` WHERE cmd_id = '@newCmdId';
...
INSERT INTO `command` (`command_name`, `command_line`, `command_example`, `command_type`, `graph_id`) VALUES ('check_discovery_memory', '$USER1$/check_centreon_snmp_memory -H $HOSTADDRESS$ -C $_HOSTSNMPCOMMUNITY$ -v 2 -w $ARG1$ -c $ARG2$', '!80!90', '2', '');
SELECT @newCmdId := MAX(command_id) FROM command;
DELETE FROM `command_arg_description` WHERE cmd_id = '@newCmdId';
...
INSERT INTO `command` (`command_name`, `command_line`, `command_example`, `command_type`, `graph_id`) VALUES ('check_discovery_memory_cisco', '$USER1$/check_snmp_mem.pl -H $HOSTADDRESS$ -C $_HOSTSNMPCOMMUNITY$ -2 -I -w $ARG1$ -c $ARG2$ -f', '!80!90', '2', '');
SELECT @newCmdId := MAX(command_id) FROM command;
DELETE FROM `command_arg_description` WHERE cmd_id = '@newCmdId';
INSERT INTO `command_arg_description` (cmd_id, macro_name, macro_description) VALUES (@newCmdId, 'ARG1', 'warning level'), (@newCmdId, 'ARG2', 'critical level');
/* ------------------------------------------------------------------------------------------------- */
...
INSERT INTO `command` (`command_name`, `command_line`, `command_example`, `command_type`, `graph_id`) VALUES ('check_discovery_proc', '$USER1$/check_centreon_snmp_process -H $HOSTADDRESS$ -C $_HOSTSNMPCOMMUNITY$ -v 2 -p $ARG1$', '!sshd', '2', '');
SELECT @newCmdId := MAX(command_id) FROM command;
DELETE FROM `command_arg_description` WHERE cmd_id = '@newCmdId';
...
INSERT INTO `command` (`command_name`, `command_line`, `command_example`, `command_type`, `graph_id`) VALUES ('check_discovery_bandwidth_by_name', '$USER1$/check_centreon_snmp_traffic.pl -H $HOSTADDRESS$ -C $_HOSTSNMPCOMMUNITY$ -v 2 -i $ARG1$ -n -w $ARG2$ -c $ARG3$ -S', '!FastEthernet0/1!80!90', '2', '');
SELECT @newCmdId := MAX(command_id) FROM command;
DELETE FROM `command_arg_description` WHERE cmd_id = '@newCmdId';
...
INSERT INTO `command` (`command_name`, `command_line`, `command_example`, `command_type`, `graph_id`) VALUES ('check_discovery_bandwidth_by_number', '$USER1$/check_centreon_snmp_traffic.pl -H $HOSTADDRESS$ -C $_HOSTSNMPCOMMUNITY$ -v 2 -i $ARG1$ -w $ARG2$ -c $ARG3$ -S', '!1!80!90', '2', '');
SELECT @newCmdId := MAX(command_id) FROM command;
DELETE FROM `command_arg_description` WHERE cmd_id = '@newCmdId';
...
SELECT @newCmdId := command_id FROM command where command_name = 'check_discovery_bandwidth_by_name';

/* Relation between Template and Command for Cisco switch */
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Cisco_sw_bandwidth', 'Cisco_sw_bandwidth', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!FastEthernet0/1!80!90', NULL, '0', '0');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
SELECT @newCmdId := command_id FROM command where command_name = 'check_discovery_memory_cisco';

/* Relation between Template and Command for Cisco switch */
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Cisco_sw_mem', 'Cisco_sw_mem', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!80!90', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Cisco_rt_load', 'Cisco_rt_load', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!cisco!80,70,60!90,80,70', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
/* Relation between Template and Command for Cisco router */
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Cisco_rt_bandwidth', 'Cisco_rt_bandwidth', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!Ethernet0/0!80!90', NULL, '0', '0');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Cisco_rt_mem', 'Cisco_rt_mem', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!80!90', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
/* Relation between Template and Command for Cisco router */
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Cisco_fw_asa_load', 'Cisco_fw_asa_load', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!cisco!70,60,50!80,70,60', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
/* Relation between Template and Command for Cisco router */
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Cisco_fw_asa_bandwidth', 'Cisco_fw_asa_bandwidth', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!Adaptive Security Appliance \'Outside\' interface!80!90', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
/* Relation between Template and Command for Cisco routeur */
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Cisco_fw_asa_mem', 'Cisco_fw_asa_mem', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!80!90', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
SELECT @newCmdId := command_id FROM command where command_name = 'check_discovery_bandwidth_by_number';

/* Relation between Template and Command for Alcatel OmniSwitch */
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Alcatel_sw_bandwidth', 'Alcatel_sw_bandwidth', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!1!80!90', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
SELECT @newCmdId := command_id FROM command where command_name = 'check_discovery_memory';

/* Relation between Template and Command for Linux Server */
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Linux_srv_mem', 'Linux_srv_mem', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!80!90', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
/* Relation between Template and Command for Linux Server */
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Linux_srv_load', 'Linux_srv_load', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!netsl!4,3,2!5,4,3', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
/* Command to monitor Load on Linux server */
SELECT @newCmdId := command_id FROM command where command_name = 'check_discovery_disk';

/* Relation between Template and Command for Linux Server */
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Linux_srv_disk', 'Linux_srv_disk', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!/!80!90', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
SELECT @newCmdId := command_id FROM command where command_name = 'check_discovery_proc';

/* Relation between Template and Command for Linux Server */
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Linux_srv_proc', 'Linux_srv_proc', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!sshd', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO host (host_template_model_htm_id, command_command_id, command_command_id_arg1, timeperiod_tp_id, timeperiod_tp_id2, command_command_id2, command_command_id_arg2,host_name, host_alias, host_address, host_max_check_attempts, host_check_interval, host_retry_check_interval, host_active_checks_enabled, host_passive_checks_enabled, host_checks_enabled, host_obsess_over_host, host_check_freshness, host_freshness_threshold, host_event_handler_enabled, host_low_flap_threshold, host_high_flap_threshold, host_flap_detection_enabled, host_process_perf_data, host_retain_status_information, host_retain_nonstatus_information, host_notification_interval, host_first_notification_delay, host_notification_options, host_notifications_enabled, host_stalking_options, host_snmp_community, host_snmp_version, host_location, host_comment, host_register, host_activate) VALUES ( '2', NULL, NULL, NULL, NULL, NULL, NULL, 'discovery-windows-server', 'Model for Windows server from Discovery module', NULL, NULL, NULL, NULL, '2', '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, NULL, '2', NULL, NULL, '0', NULL, NULL, '0', '1');
SELECT @newHostId := MAX(host_id) FROM host;
SELECT @genTemplateId := host_id FROM host where ( host_name = "generic-host" );
INSERT INTO host_template_relation (`host_host_id`, `host_tpl_id`, `order`) VALUES (@newHostId, @genTemplateId, 1);
DELETE FROM host_hostparent_relation WHERE host_host_id = '@newHostId';
...
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Win_srv_mem', 'Win_srv_mem', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!80!90', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
/* Relation between Template and Command for Windows server */
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Win_srv_cpu', 'Win_srv_cpu', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!stand!80!90', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
/* Relation between Template and Command for Windows server */
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Win_srv_disk', 'Win_srv_disk', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!C:!80!90', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
/* Relation between Template and Command for Windows server */
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Win_srv_proc', 'Linux_srv_proc', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!explorer.exe', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `command` (`command_name`, `command_line`, `command_example`, `command_type`, `graph_id`) VALUES ('check_discovery_win_service', '$USER1$/check_snmp_win.pl -H $HOSTADDRESS$ -C $_HOSTSNMPCOMMUNITY$ -2 -T service -n "$ARG1$" -f', '!Client DNS', '2', '');
SELECT @newCmdId := MAX(command_id) FROM command;
DELETE FROM `command_arg_description` WHERE cmd_id = '@newCmdId';
INSERT INTO `command_arg_description` (cmd_id, macro_name, macro_description) VALUES (@newCmdId, 'ARG1', 'service name (complete name)');

/* Relation between Template and Command for Windows server */
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Win_srv_service', 'Win_srv_service', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!Journal des .v.nements', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO host_service_relation (hostgroup_hg_id, host_host_id, servicegroup_sg_id, service_service_id) VALUES (NULL, @newHostId, NULL, @newServiceId);
DELETE FROM servicegroup_relation WHERE service_service_id = '@newServiceId';
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
...
/* Relation between Template and Command for Cisco router */
INSERT INTO service (service_template_model_stm_id, command_command_id, timeperiod_tp_id, command_command_id2, timeperiod_tp_id2, service_description, service_alias, service_is_volatile, service_max_check_attempts, service_normal_check_interval, service_retry_check_interval, service_active_checks_enabled, service_passive_checks_enabled, service_obsess_over_service, service_check_freshness, service_freshness_threshold, service_event_handler_enabled, service_low_flap_threshold, service_high_flap_threshold, service_flap_detection_enabled, service_process_perf_data, service_retain_status_information, service_retain_nonstatus_information, service_notification_interval, service_notification_options, service_notifications_enabled, service_stalking_options, service_first_notification_delay ,service_comment, command_command_id_arg, command_command_id_arg2, service_register, service_activate) VALUES ( '1', @newCmdId, NULL, NULL, NULL, 'Cisco_env', 'Cisco_env', '2', NULL, NULL, NULL, '2', '2', '2', '2', NULL, '2', NULL, NULL, '2', '2', '2', '2', NULL, NULL, '2', NULL, NULL, NULL, '!cisco', NULL, '0', '1');
SELECT @newServiceId := MAX(service_id) FROM service;
INSERT INTO `extended_service_information` ( `esi_id` , `service_service_id`, `esi_notes` , `esi_notes_url` , `esi_action_url` , `esi_icon_image` , `esi_icon_image_alt`, `graph_id` )VALUES ( NULL, @newServiceId, NULL, NULL, NULL, NULL, NULL, NULL);
/* for switch */
