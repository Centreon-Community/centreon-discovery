...
# 
# SVN : $URL: http://svn.centreon.com/trunk/plugins-2.x/src/check_centreon_snmp_remote_storage $
# SVN : $Id: check_centreon_snmp_remote_storage 11631 2011-02-08 17:02:51Z shotamchay $
#
#####################################################################################
#
# Script init
...
my $cacheFile = "/var/lib/centreon/centplugins/remote_storage_cache_".$opt_H;
my $result;
my $mustCreateFile = 0;
my $row;
my $countLine;
