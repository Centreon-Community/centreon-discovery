...
<html lang="fr">
	<head>
		...
		<title>Discovery</title>
                <link rel="stylesheet" media="screen" type="text/css" title="Discovery" href="./modules/Centreon-Discovery/css/discovery.css"/>
	...
	<body style="background-color: rgb(255, 255, 255); color: rgb(0, 0, 0); height: 158px;" alink="#ff6600" link="#ff6600" vlink="#ff6600">  
		<span class="" style="font-family: Candara;  font-weight: bold;"><br>
           ...
           // require_once './modules/DB-Func.php';
			...
			<table width="100%">
				<tr>
					<td width="30%"><img alt ="CentrESIEEon" src="./modules/Centreon-Discovery/include/images/img_CentrESIEEon.png"/></td>
				...
				switch ($id) {
					...
					case 2: {
						...
						while ($relationsData=mysql_fetch_array($relations,MYSQL_ASSOC)){
							...
							echo '  <td class="ListColHeaderCenter"><input type="image" src="./modules/Centreon-Discovery/include/images/delete16x16.png" title="Delete One from List" name="'.$relationsData["id"].'" value="'.$relationsData["id"].'" onClick="self.location=\'./main.php?p=61204&id=2\'"></td>',"\n";
							echo ' </tr>'." \n ";
						}
						echo '    </table>'."\n";
						echo ' </form>'."\n";
