 ...
 */
require_once './modules/Centreon-Discovery/include/DB-Func.php';
require_once './modules/Centreon-Discovery/include/common.php';
 ?>
...
<html lang="fr">
	<head>
		...
		<script type="text/javascript" src="./modules/Centreon-Discovery/include/jquery-1.6.4.min.js"></script>
		<script type="text/javascript" src="./modules/Centreon-Discovery/include/script.js"></script>
	...
	<body style="background-color: rgb(255, 255, 255); color: rgb(0, 0, 0); height: 158px;" alink="#ff6600" link="#ff6600" vlink="#ff6600">  
		<span class="" style="font-family: Candara;  font-weight: bold;">
			...
			<table width="100%">
				<tr>
					<td width="30%"><img alt="CentESIEEon" src="./modules/Centreon-Discovery/include/images/img_CentrESIEEon.png" /></td>
			...
			<?php
				...
				function doFormTab(){
					...
					if (file_exists("./modules/Centreon-Discovery/include/agent/DiscoveryAgent_central.py")) {
						//shell_exec('python ./modules/Centreon-Discovery/DiscoveryAgent_central.py STATUS_POLLER > /dev/null 2>&1 &');
						exec('python ./modules/Centreon-Discovery/include/agent/DiscoveryAgent_central.py STATUS_POLLER > /dev/null 2>&1 &');
					}
                    ...
                    while($data= mysql_fetch_array($sql,MYSQL_ASSOC)){
						...
						echo ' <td class="ListColCenter" onClick="afficher_cacher(\'td_toggle'.$i.'\',\'td_toggle\');"><div id="status'.$i.'" class="status"><p id="'.$data["id"].'" style="display:none"></p><img style="border:none" type="image" src="./modules/Centreon-Discovery/include/images/loading.gif" title="Loading..."></div></td>'."\n ";
                        echo ' <td class="ListColCenter"><input style="border:none" type="image" src="./modules/Centreon-Discovery/include/images/delete16x16.png" title="Delete one from list" name="clear'.$data["id"].'" value="'.$data["id"].'" onClick="self.location=\'./main.php?p=61201\'"></td>',"\n ";
						echo ' <td class="ListColCenter" onClick="afficher_cacher(\'td_toggle'.$i.'\',\'td_toggle\');"><img style="border:none" type="image" src="./modules/Centreon-Discovery/include/images/options.jpg" title="Options"></td></tr>'."\n ";
				...
				function doDropDownList ($id){
					...
					$list.='</select>  <img style="border:none" type="image" src="./modules/Centreon-Discovery/include/images/check.png" onClick="request(\'./modules/Centreon-Discovery/include/update.php\',\'xmlhttp\',\'poller'.$id.'\',\''.$id.'\');" title="Check poller status">';
					return $list;
				}
