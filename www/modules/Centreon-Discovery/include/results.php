...
<html lang="fr">
    <head>
            ...
            <script type="text/javascript" src="./modules/Centreon-Discovery/include/JS-Func.js"></script>
    ...
    <body style="background-color: rgb(255, 255, 255); color: rgb(0, 0, 0); height: 158px;" alink="#ff6600" link="#ff6600" vlink="#ff6600">
        <span class="" style="font-family: Candara;  font-weight: bold;"><br>
            ...
            <table width="100%">
                <tr>
                    <td width="30%"><img src="./modules/Centreon-Discovery/include/images/img_CentrESIEEon.png" alt="CentrESIEEon" /></td>
            ...
            <?php
				...
				*/
				function setScanValues(){
					...
					//	shell_exec('python ./modules/Centreon-Discovery/include/agent/DiscoveryAgent_central.py SCAN_RANGEIP > /dev/null 2>&1 &');
						exec('python ./modules/Centreon-Discovery/include/agent/DiscoveryAgent_central.py SCAN_RANGEIP > /dev/null 2>&1 &');
