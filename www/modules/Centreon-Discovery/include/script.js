...
{
$.post('./modules/Centreon-Discovery/include/verif_discovery_status.php', { id: plage_id }, function(data) 
	{
...
function request(url,cadre,source,id) {
	...
	XHR.open("POST","./modules/Centreon-Discovery/include/update.php",true);
