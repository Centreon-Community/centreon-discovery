...
('', 'About', './img/icones/16x16/about.gif', 612, 61204, 101, 1, './modules/Discovery/include/informations.php', NULL, '0', '1', '1');
...
CREATE TABLE IF NOT EXISTS `mod_discovery_rangeip` (
  ...
  `cidr` int(2) NOT NULL,
-- pour nmap
  `nmap_profil` varchar(15) COLLATE utf8_bin NOT NULL DEFAULT 'Insane(T5)', 
